...
public static class ModelGoldie extends EntityModel {
	...
	public ModelGoldie() {
		...
		Head.cubeList.add(new ModelBox(Head, 20, 20, -2.5F, -19.1F, -5.0F, 5, 3, 10, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 0, 48, -0.75F, -18.1F, -5.4F, 1, 1, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 18, 38, 1.0F, -18.1F, -5.7F, 1, 1, 2, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 30, 0, -2.0F, -21.1F, -4.5F, 4, 3, 9, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 36, 33, -1.0F, -20.8F, -4.8F, 2, 3, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 47, 7, -0.5F, -20.3F, -5.0F, 1, 1, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 50, 5, -3.0F, -21.1F, -3.5F, 1, 3, 7, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 43, 48, 2.0F, -21.1F, -3.5F, 1, 3, 7, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 61, 37, -4.0F, -21.1F, -2.5F, 1, 3, 5, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 61, 28, 3.0F, -21.1F, -2.5F, 1, 3, 5, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 44, 36, -3.5F, -21.6F, -2.0F, 7, 2, 4, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 61, 22, -1.5F, -22.1F, -2.0F, 3, 2, 4, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 40, 25, -1.0F, -22.3F, -1.0F, 2, 2, 2, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 18, 33, -2.5F, -22.1F, -1.5F, 1, 2, 3, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 22, 23, 1.5F, -22.1F, -1.5F, 1, 2, 3, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 0, 4, -1.5F, -21.6F, -4.0F, 3, 2, 2, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 0, 0, -1.5F, -21.6F, 2.0F, 3, 2, 2, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 0, 44, -0.5F, -22.2F, 2.5F, 1, 3, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 8, 47, 1.5F, -21.6F, 2.0F, 1, 2, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 44, 36, -2.5F, -21.6F, 2.0F, 1, 2, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 8, 44, -2.5F, -21.6F, -3.0F, 1, 2, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 42, 15, 1.5F, -21.6F, -3.0F, 1, 2, 1, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 42, 25, -3.5F, -19.1F, -4.0F, 1, 3, 8, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 40, 12, 2.5F, -19.1F, -4.0F, 1, 3, 8, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 14, 54, -4.5F, -19.1F, -3.0F, 1, 3, 6, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 53, 53, 3.5F, -19.1F, -3.0F, 1, 3, 6, 0.0F, false));
		...
		Legs.cubeList.add(new ModelBox(Legs, 16, 63, 6.2F, -12.0F, -0.5F, 1, 8, 1, 0.0F, false));
		...
		Legs.cubeList.add(new ModelBox(Legs, 12, 63, -7.2F, -12.0F, -0.5F, 1, 8, 1, 0.0F, false));
		...
		Legs.cubeList.add(new ModelBox(Legs, 0, 0, 6.5F, -14.0F, -0.5F, 1, 2, 1, 0.0F, false));
		Legs.cubeList.add(new ModelBox(Legs, 0, 0, -7.5F, -14.0F, -0.5F, 1, 2, 1, 0.0F, false));

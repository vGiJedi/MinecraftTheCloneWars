...
public static class ModelgeonosianBezerker extends EntityModel {
	...
	public ModelgeonosianBezerker() {
		...
		cube_r3_r1.cubeList.add(new ModelBox(cube_r3_r1, 0, 67, 5.5F, -26.5F, -0.5F, 1, 6, 1, 0.0F, false));
		cube_r3_r1.cubeList.add(new ModelBox(cube_r3_r1, 18, 24, 5.5F, -20.25F, -2.0F, 1, 1, 1, 0.0F, false));
		cube_r3_r1.cubeList.add(new ModelBox(cube_r3_r1, 66, 57, 5.5F, -20.5F, -1.0F, 1, 3, 2, 0.0F, false));

		RightArm = new ModelRenderer(this);
		RightArm.setRotationPoint(-5.0F, -32.5F, 2.0F);
		Geonosian.addChild(RightArm);
		RightArm.cubeList.add(new ModelBox(RightArm, 61, 41, -2.0F, 2.0F, -1.0F, 2, 5, 2, 0.0F, true));
		RightArm.cubeList.add(new ModelBox(RightArm, 40, 49, -2.0F, -2.0F, -2.0F, 2, 4, 4, 0.0F, true));
		RightArm.cubeList.add(new ModelBox(RightArm, 69, 11, -2.25F, -4.0F, -0.5F, 1, 5, 1, 0.0F, true));

		cube_r23 = new ModelRenderer(this);
		cube_r23.setRotationPoint(-2.75F, 8.5F, -1.0F);
		RightArm.addChild(cube_r23);
		setRotationAngle(cube_r23, -0.7854F, 0.0F, 0.0F);
		cube_r23.cubeList.add(new ModelBox(cube_r23, 0, 67, 1.25F, -2.5F, -1.5F, 1, 6, 1, 0.0F, true));
		cube_r23.cubeList.add(new ModelBox(cube_r23, 18, 24, 1.25F, 3.75F, -3.0F, 1, 1, 1, 0.0F, true));
		cube_r23.cubeList.add(new ModelBox(cube_r23, 66, 57, 1.25F, 3.5F, -2.0F, 1, 3, 2, 0.0F, true));
		cube_r23.cubeList.add(new ModelBox(cube_r23, 0, 80, 1.75F, 4.5F, -21.0F, 1, 1, 26, 0.0F, true));
		cube_r23.cubeList.add(new ModelBox(cube_r23, 64, 98, 1.75F, 5.5F, -20.0F, 1, 1, 16, 0.0F, true));
		cube_r23.cubeList.add(new ModelBox(cube_r23, 88, 116, 1.75F, 6.5F, -17.0F, 1, 1, 11, 0.0F, true));

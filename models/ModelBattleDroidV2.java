...
public static class ModelBattleDroidV2 extends EntityModel {
	...
	public ModelBattleDroidV2() {
		...
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 6, 41, -6.0F, -22.5F, -14.75F, 1, 1, 2, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 35, 21, -6.0F, -28.25F, -17.75F, 1, 2, 1, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 0, 0, -6.0F, -29.25F, -20.75F, 1, 1, 11, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 8, 34, -6.0F, -28.25F, -11.75F, 1, 2, 1, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 0, 34, -6.0F, -28.25F, -14.75F, 1, 2, 1, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 33, 15, -6.0F, -28.25F, -20.5F, 1, 2, 1, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 49, 0, -6.5F, -27.0F, -17.75F, 2, 1, 1, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 5, 0, -6.0F, -27.0F, -22.75F, 1, 1, 2, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 43, 19, -6.5F, -27.5F, -20.75F, 2, 2, 3, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 0, 12, -6.5F, -27.5F, -16.75F, 2, 2, 8, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 40, 36, -6.0F, -26.0F, -15.75F, 1, 1, 1, 0.0F, false));
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 12, 12, -6.0F, -25.5F, -14.75F, 1, 3, 1, 0.0F, false));

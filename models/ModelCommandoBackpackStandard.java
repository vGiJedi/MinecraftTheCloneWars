...
public static class ModelCommandoBackpackStandard extends EntityModel {
	private final ModelRenderer Body;
	private final ModelRenderer RightArm;
	private final ModelRenderer LeftArm;

	public ModelCommandoBackpackStandard() {
		textureWidth = 128;
		textureHeight = 128;
		...
		Body.cubeList.add(new ModelBox(Body, 37, 50, -4.5F, 1.5F, 3.5F, 9, 2, 2, 0.0F, false));
		...
		Body.cubeList.add(new ModelBox(Body, 45, 0, 3.25F, 7.5F, 4.5F, 1, 3, 1, 0.0F, false));
		Body.cubeList.add(new ModelBox(Body, 45, 7, 0.25F, 7.5F, 4.5F, 1, 3, 1, 0.0F, false));
		Body.cubeList.add(new ModelBox(Body, 44, 14, -1.25F, 7.5F, 4.5F, 1, 3, 1, 0.0F, false));
		Body.cubeList.add(new ModelBox(Body, 44, 0, -3.25F, 9.5F, 4.5F, 2, 1, 1, 0.0F, false));
		Body.cubeList.add(new ModelBox(Body, 36, 0, 1.25F, 9.5F, 4.5F, 2, 1, 1, 0.0F, true));

...
public static class ModelAnakin extends EntityModel {
	private final ModelRenderer CloneModel;
	...
	public ModelAnakin() {
		...
		CloneModel = new ModelRenderer(this);
		CloneModel.setRotationPoint(0.0F, 24.0F, 0.0F);

		Head = new ModelRenderer(this);
		Head.setRotationPoint(0.0F, -24.0F, 0.0F);
		CloneModel.addChild(Head);

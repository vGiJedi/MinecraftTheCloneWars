...
public static class ModelCommandoDroidCaptain extends EntityModel {
	...
	public ModelCommandoDroidCaptain() {
		...
		cube_r16.cubeList.add(new ModelBox(cube_r16, 22, 39, 1.75F, 1.25F, -3.25F, 1, 3, 1, 0.0F, false));
		cube_r16.cubeList.add(new ModelBox(cube_r16, 24, 30, 1.75F, 1.25F, -14.25F, 1, 1, 1, 0.0F, false));
		cube_r16.cubeList.add(new ModelBox(cube_r16, 0, 0, 1.75F, 1.25F, -13.25F, 1, 2, 10, 0.0F, false));
		cube_r16.cubeList.add(new ModelBox(cube_r16, 4, 25, 1.75F, 1.25F, -2.25F, 1, 2, 3, 0.0F, false));
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		CommandoDroidCaptain.render(f5);
	}

...
public static class ModelLaserYellow extends EntityModel {
	private final ModelRenderer Laser;
	private final ModelRenderer cube_r1;

	public ModelLaserYellow() {
		textureWidth = 32;
		textureHeight = 32;
		...
		cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 0, 8.5F, 7.0F, -9.0F, 1, 1, 8, 0.0F, false));
	}

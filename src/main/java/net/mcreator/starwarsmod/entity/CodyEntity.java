...
import net.mcreator.starwarsmod.item.CodysJetpackItem;
import net.mcreator.starwarsmod.item.CodysHelmetItem;
...
public class CodyEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("cody").setRegistryName("cody");
	public CodyEntity(StarwarsmodModElements instance) {
		super(instance, 201);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -39373, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("cody_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/cody.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(CodysHelmetItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(CodysJetpackItem.body));
		}

...
import net.mcreator.starwarsmod.procedures.NavalOfficerKillsAnotherOneProcedure;
...
public class NavalOfficerEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("naval_officer").setRegistryName("naval_officer");
	public NavalOfficerEntity(StarwarsmodModElements instance) {
		super(instance, 200);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -6750157, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("naval_officer_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/naval.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(18, new RandomWalkingGoal(this, 1));
			this.goalSelector.addGoal(19, new LookAtGoal(this, PlayerEntity.class, (float) 5));
			this.goalSelector.addGoal(20, new LookAtGoal(this, AnakinSkywalkerEntity.CustomEntity.class, (float) 5));
			this.goalSelector.addGoal(21, new LookAtGoal(this, ObiWanKenobiEntity.CustomEntity.class, (float) 5));
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				NavalOfficerKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}

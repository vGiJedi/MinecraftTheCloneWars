...
import net.mcreator.starwarsmod.procedures.CloneCommandoFixerThisEntityKillsAnotherOneProcedure;
import net.mcreator.starwarsmod.item.FixersBackpackItem;
import net.mcreator.starwarsmod.item.FixersAntennaItem;
...
public class CloneCommandoFixerEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_commando_fixer").setRegistryName("clone_commando_fixer");
	public CloneCommandoFixerEntity(StarwarsmodModElements instance) {
		super(instance, 255);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -16751104, new Item.Properties().group(null)).setRegistryName("clone_commando_fixer_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/clone_commando_fixer.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(FixersAntennaItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(FixersBackpackItem.body));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:fixerhurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:fixerdeath"));
		}
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				CloneCommandoFixerThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}

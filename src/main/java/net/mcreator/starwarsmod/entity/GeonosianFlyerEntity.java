...
import net.mcreator.starwarsmod.item.GeonosianBlasterItem;
...
public class GeonosianFlyerEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 2f))
					.build("geonosian_flyer").setRegistryName("geonosian_flyer");
	public GeonosianFlyerEntity(StarwarsmodModElements instance) {
		super(instance, 401);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12834800, -10928612, new Item.Properties().group(SepratistAIItemGroup.tab))
				.setRegistryName("geonosian_flyer_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelgeonosian(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/geonosian.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(24, new NearestAttackableTargetGoal(this, MouseDroidEntity.CustomEntity.class, true, false));
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound(
					(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:geonosianwingflap")),
					0.15f, 1);
		}
		...
		protected void registerAttributes() {
			...
			this.getAttribute(SharedMonsterAttributes.FLYING_SPEED).setBaseValue(0.325);
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			GeonosianBlasterItem.shoot(this, target);
		}
	...
	public static class Modelgeonosian extends EntityModel {
		...
		public Modelgeonosian() {
			...
			addBoxHelper(RightArm, 61, 11, -2.0F, 2.0F, -1.0F, 2, 5, 2, 0.0F, false);
			addBoxHelper(RightArm, 12, 47, -2.0F, -2.0F, -2.0F, 2, 4, 4, 0.0F, false);
			addBoxHelper(RightArm, 10, 69, -2.25F, -4.0F, -0.5F, 1, 5, 1, 0.0F, false);
			cube_r1 = new ModelRenderer(this);
			cube_r1.setRotationPoint(6.0F, 8.5F, 5.75F);
			RightArm.addChild(cube_r1);
			setRotationAngle(cube_r1, -1.789F, 0.0F, 0.0F);
			addBoxHelper(cube_r1, 14, 55, -9.0F, 15.5F, -3.84F, 1, 6, 1, 0.0F, false);
			addBoxHelper(cube_r1, 18, 66, -6.0F, 15.5F, -3.84F, 1, 6, 1, 0.0F, false);
			cube_r2 = new ModelRenderer(this);
			cube_r2.setRotationPoint(-2.75F, 8.5F, -1.0F);
			RightArm.addChild(cube_r2);
			setRotationAngle(cube_r2, -1.789F, 0.0F, 0.0F);
			addBoxHelper(cube_r2, 41, 65, 1.25F, 9.5F, -3.8F, 1, 7, 1, 0.0F, false);
			addBoxHelper(cube_r2, 14, 66, 1.25F, 9.5F, -6.8F, 1, 7, 1, 0.0F, false);
			addBoxHelper(cube_r2, 39, 26, 0.25F, 4.5F, -6.3F, 3, 2, 1, 0.0F, false);
			addBoxHelper(cube_r2, 46, 0, 0.25F, 7.5F, -6.3F, 3, 6, 3, 0.0F, false);
			addBoxHelper(cube_r2, 58, 25, 0.75F, 2.5F, -5.8F, 2, 5, 2, 0.0F, false);
			addBoxHelper(cube_r2, 32, 19, 1.25F, 5.5F, -1.8F, 1, 2, 1, 0.0F, false);
			addBoxHelper(cube_r2, 20, 19, 1.25F, 6.5F, -3.8F, 1, 1, 2, 0.0F, false);
			addBoxHelper(cube_r2, 7, 44, 1.25F, 4.5F, -3.8F, 1, 1, 3, 0.0F, false);
			addBoxHelper(cube_r2, 59, 69, 1.25F, -0.5F, -2.8F, 1, 5, 1, 0.0F, false);
			...
			addBoxHelper(cube_r3, 0, 67, -2.25F, -2.5F, -1.5F, 1, 6, 1, 0.0F, false);
			addBoxHelper(cube_r3, 18, 24, -2.25F, 3.75F, -3.0F, 1, 1, 1, 0.0F, false);
			addBoxHelper(cube_r3, 66, 57, -2.25F, 3.5F, -2.0F, 1, 3, 2, 0.0F, false);

...
import net.mcreator.starwarsmod.procedures.CloneCommandoScorchThisEntityKillsAnotherOneProcedure;
import net.mcreator.starwarsmod.item.ScorchBackpackItem;
import net.mcreator.starwarsmod.item.DC17MGRENADEItem;
...
public class CloneCommandoScorchEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_commando_scorch").setRegistryName("clone_commando_scorch");
	public CloneCommandoScorchEntity(StarwarsmodModElements instance) {
		super(instance, 247);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -3493371, new Item.Properties().group(null)).setRegistryName("clone_commando_scorch_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/clone_commando_scorch.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DC17MGRENADEItem.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(ScorchBackpackItem.body));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:scorchhurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:scorchdeath"));
		}
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				CloneCommandoScorchThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			DC17MGRENADEItem.shoot(this, target);
		}
	}
}

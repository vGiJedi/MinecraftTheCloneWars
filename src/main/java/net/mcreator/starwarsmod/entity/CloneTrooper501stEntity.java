...
public class CloneTrooper501stEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_trooper_501st").setRegistryName("clone_trooper_501st");
	public CloneTrooper501stEntity(StarwarsmodModElements instance) {
		super(instance, 221);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16776961, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_trooper_501st_spawn_egg"));
	}

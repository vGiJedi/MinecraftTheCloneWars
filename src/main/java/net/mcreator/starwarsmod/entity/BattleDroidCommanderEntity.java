...
import net.mcreator.starwarsmod.item.RG4DItem;
...
public class BattleDroidCommanderEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 2f))
					.build("battle_droid_commander").setRegistryName("battle_droid_commander");
	public BattleDroidCommanderEntity(StarwarsmodModElements instance) {
		super(instance, 398);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13159, -3757296, new Item.Properties().group(SepratistAIItemGroup.tab))
				.setRegistryName("battle_droid_commander_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelBattleDroidCommander(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/battledroidcommander.png");
				}
			};
		});
	}
	...
	public static class ModelBattleDroidCommander extends EntityModel {
		...
		public ModelBattleDroidCommander() {
			...
			addBoxHelper(RightArm_r1, 0, 12, -6.5F, -26.5F, -17.75F, 2, 1, 8, 0.0F, false);
			addBoxHelper(RightArm_r1, 0, 60, -6.5F, -27.5F, -14.75F, 2, 1, 3, 0.0F, false);

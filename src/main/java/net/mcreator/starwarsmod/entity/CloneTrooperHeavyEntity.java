...
import net.mcreator.starwarsmod.item.WhitefinandgrayvisorItem;
import net.mcreator.starwarsmod.item.DC15Item;
import net.mcreator.starwarsmod.item.DC15CItem;
import net.mcreator.starwarsmod.item.AmmoBagAndBackpackItem;
...
public class CloneTrooperHeavyEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_trooper_heavy").setRegistryName("clone_trooper_heavy");
	public CloneTrooperHeavyEntity(StarwarsmodModElements instance) {
		super(instance, 220);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_trooper_heavy_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(WhitefinandgrayvisorItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(AmmoBagAndBackpackItem.body));
		}

...
import net.mcreator.starwarsmod.gui.R2InventoryGui;
...
public class R2D2Entity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("r_2_d_2").setRegistryName("r_2_d_2");
	public R2D2Entity(StarwarsmodModElements instance) {
		super(instance, 114);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16763905, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("r_2_d_2_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelASTROMECHMoving(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/r2d2_moving.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, GoldieEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, BuzzDroidMobEntity.CustomEntity.class, true, false));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("R2D2");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new R2InventoryGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	public static class ModelASTROMECHMoving extends EntityModel {
		...
		public ModelASTROMECHMoving() {
			...
			addBoxHelper(Head, 20, 20, -2.5F, -1.6F, -4.5F, 5, 3, 10, 0.0F, false);
			addBoxHelper(Head, 0, 48, -0.75F, -0.6F, -4.9F, 1, 1, 1, 0.0F, false);
			addBoxHelper(Head, 18, 38, 1.0F, -0.6F, -5.2F, 1, 1, 2, 0.0F, false);
			addBoxHelper(Head, 30, 0, -2.0F, -3.6F, -4.0F, 4, 3, 9, 0.0F, false);
			addBoxHelper(Head, 36, 33, -1.0F, -3.3F, -4.3F, 2, 3, 1, 0.0F, false);
			addBoxHelper(Head, 47, 7, -0.5F, -2.8F, -4.5F, 1, 1, 1, 0.0F, false);
			addBoxHelper(Head, 50, 5, -3.0F, -3.6F, -3.0F, 1, 3, 7, 0.0F, false);
			addBoxHelper(Head, 43, 48, 2.0F, -3.6F, -3.0F, 1, 3, 7, 0.0F, false);
			addBoxHelper(Head, 61, 37, -4.0F, -3.6F, -2.0F, 1, 3, 5, 0.0F, false);
			addBoxHelper(Head, 61, 28, 3.0F, -3.6F, -2.0F, 1, 3, 5, 0.0F, false);
			addBoxHelper(Head, 44, 36, -3.5F, -4.1F, -1.5F, 7, 2, 4, 0.0F, false);
			addBoxHelper(Head, 61, 22, -1.5F, -4.6F, -1.5F, 3, 2, 4, 0.0F, false);
			addBoxHelper(Head, 40, 25, -1.0F, -4.8F, -0.5F, 2, 2, 2, 0.0F, false);
			addBoxHelper(Head, 18, 33, -2.5F, -4.6F, -1.0F, 1, 2, 3, 0.0F, false);
			addBoxHelper(Head, 22, 23, 1.5F, -4.6F, -1.0F, 1, 2, 3, 0.0F, false);
			addBoxHelper(Head, 0, 4, -1.5F, -4.1F, -3.5F, 3, 2, 2, 0.0F, false);
			addBoxHelper(Head, 0, 0, -1.5F, -4.1F, 2.5F, 3, 2, 2, 0.0F, false);
			addBoxHelper(Head, 0, 44, -0.5F, -4.7F, 3.0F, 1, 3, 1, 0.0F, false);
			addBoxHelper(Head, 8, 47, 1.5F, -4.1F, 2.5F, 1, 2, 1, 0.0F, false);
			addBoxHelper(Head, 44, 36, -2.5F, -4.1F, 2.5F, 1, 2, 1, 0.0F, false);
			addBoxHelper(Head, 8, 44, -2.5F, -4.1F, -2.5F, 1, 2, 1, 0.0F, false);
			addBoxHelper(Head, 42, 15, 1.5F, -4.1F, -2.5F, 1, 2, 1, 0.0F, false);
			addBoxHelper(Head, 42, 25, -3.5F, -1.6F, -3.5F, 1, 3, 8, 0.0F, false);
			addBoxHelper(Head, 40, 12, 2.5F, -1.6F, -3.5F, 1, 3, 8, 0.0F, false);
			addBoxHelper(Head, 14, 54, -4.5F, -1.6F, -2.5F, 1, 3, 6, 0.0F, false);
			addBoxHelper(Head, 53, 53, 3.5F, -1.6F, -2.5F, 1, 3, 6, 0.0F, false);
			...
			addBoxHelper(Legs, 16, 63, 6.2F, -12.0F, -0.5F, 1, 11, 1, 0.0F, false);
			addBoxHelper(Legs, 52, 42, 5.0F, -15.0F, -2.5F, 2, 4, 5, 0.0F, false);
			addBoxHelper(Legs, 47, 5, 6.2F, -12.5F, -2.4F, 1, 1, 1, 0.0F, false);
			addBoxHelper(Legs, 47, 2, 6.2F, -14.5F, -2.4F, 1, 1, 1, 0.0F, false);
			addBoxHelper(Legs, 28, 33, 6.2F, -14.0F, -1.0F, 1, 2, 2, 0.0F, false);
			...
			addBoxHelper(Legs, 12, 63, -7.2F, -12.0F, -0.5F, 1, 11, 1, 0.0F, false);
			addBoxHelper(Legs, 28, 54, -7.0F, -11.0F, -1.5F, 2, 9, 3, 0.0F, false);
			addBoxHelper(Legs, 52, 23, -7.0F, -15.0F, -2.5F, 2, 4, 5, 0.0F, false);
			addBoxHelper(Legs, 47, 0, -7.2F, -12.5F, -2.4F, 1, 1, 1, 0.0F, false);
			addBoxHelper(Legs, 32, 0, -7.2F, -14.0F, -1.0F, 1, 2, 2, 0.0F, false);
			addBoxHelper(Legs, 46, 25, -7.2F, -14.5F, -2.4F, 1, 1, 1, 0.0F, false);

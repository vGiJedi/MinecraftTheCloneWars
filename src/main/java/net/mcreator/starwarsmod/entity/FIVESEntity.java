...
import net.mcreator.starwarsmod.item.FivesPauldronItem;
import net.mcreator.starwarsmod.item.DC15CItem;
import net.mcreator.starwarsmod.item.BluefinAndrangefinderItem;
...
public class FIVESEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("fives").setRegistryName("fives");
	public FIVESEntity(StarwarsmodModElements instance) {
		super(instance, 388);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -16763956, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("fives_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/arc_fives_for_3d_armour.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(BluefinAndrangefinderItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(FivesPauldronItem.body));
		}

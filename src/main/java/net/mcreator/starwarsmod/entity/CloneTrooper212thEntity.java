...
public class CloneTrooper212thEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_trooper_212th").setRegistryName("clone_trooper_212th");
	public CloneTrooper212thEntity(StarwarsmodModElements instance) {
		super(instance, 222);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -2518229, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_trooper_212th_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(18, new LookAtGoal(this, MouseDroidEntity.CustomEntity.class, (float) 5));

...
public class SuperBattleDroidJetTrooperEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 3f))
					.build("super_battle_droid_jet_trooper").setRegistryName("super_battle_droid_jet_trooper");
	public SuperBattleDroidJetTrooperEntity(StarwarsmodModElements instance) {
		super(instance, 341);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -3355444, new Item.Properties().group(SepratistAIItemGroup.tab))
				.setRegistryName("super_battle_droid_jet_trooper_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelsuperbattledroidjettrooper(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/superbattledroidjettrooper.png");
				}
			};
		});
	}
	...
	public static class Modelsuperbattledroidjettrooper extends EntityModel {
		...
		public Modelsuperbattledroidjettrooper() {
			...
			addBoxHelper(Torso, 0, 71, -0.5F, -17.5F, 0.0F, 1, 2, 2, 0.0F, true);
			...
			addBoxHelper(Torso_r1, 0, 87, 0.4F, -36.5F, 3.0F, 2, 2, 1, 0.0F, true);
			addBoxHelper(Torso_r1, 0, 87, -2.4F, -36.5F, 3.0F, 2, 2, 1, 0.0F, false);
			...
			addBoxHelper(LeftArmWeapon2, 12, 12, 13.0F, -2.5F, -1.0F, 2, 3, 8, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 24, 65, 12.5F, -2.0F, -5.0F, 1, 2, 4, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 53, 62, 13.0F, -1.5F, -9.0F, 2, 1, 4, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 62, 0, 13.5F, -2.5F, -5.0F, 1, 3, 4, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 64, 39, 13.5F, -2.0F, -8.0F, 1, 2, 3, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 53, 22, 13.5F, -1.6F, -11.0F, 1, 1, 2, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 65, 25, 13.5F, -2.6F, 0.0F, 1, 1, 4, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 49, 49, 13.5F, -0.4F, 0.0F, 1, 1, 6, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 14, 51, 13.0F, -1.5F, -12.0F, 2, 1, 3, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 48, 56, 13.0F, -0.5F, -12.0F, 2, 1, 1, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 0, 65, 14.5F, -2.0F, -5.0F, 1, 2, 4, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 70, 11, 14.5F, -2.0F, 0.0F, 1, 2, 3, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 0, 55, 14.3F, -2.0F, 4.0F, 1, 2, 2, 0.0F, true);
			addBoxHelper(LeftArmWeapon2, 55, 45, 13.5F, -2.0F, 6.5F, 1, 2, 1, 0.0F, true);
		}

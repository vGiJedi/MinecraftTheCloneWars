...
import net.mcreator.starwarsmod.item.CourscantGuardPhase2FinItem;
...
public class CloneTrooperCourscantGuardEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_trooper_courscant_guard").setRegistryName("clone_trooper_courscant_guard");
	public CloneTrooperCourscantGuardEntity(StarwarsmodModElements instance) {
		super(instance, 190);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -10092544, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_trooper_courscant_guard_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/courscant_guard_clone_trooper.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(CourscantGuardPhase2FinItem.helmet));
		}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(20, new LookAtGoal(this, SpiderDroidEntity.CustomEntity.class, (float) 5));

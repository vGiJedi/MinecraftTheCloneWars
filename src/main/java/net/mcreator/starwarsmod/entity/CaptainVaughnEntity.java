...
import net.mcreator.starwarsmod.item.VaughnsJetpackItem;
import net.mcreator.starwarsmod.item.VaughnsHelmetItem;
...
public class CaptainVaughnEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("captain_vaughn").setRegistryName("captain_vaughn");
	public CaptainVaughnEntity(StarwarsmodModElements instance) {
		super(instance, 330);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3381760, -16763956, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("captain_vaughn_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/vaughn.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DC15Item.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(VaughnsHelmetItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(VaughnsJetpackItem.body));
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(280);

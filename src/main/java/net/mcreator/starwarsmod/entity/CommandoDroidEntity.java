...
import net.mcreator.starwarsmod.item.VirobladeItem;
...
public class CommandoDroidEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 2f))
					.build("commando_droid").setRegistryName("commando_droid");
	public CommandoDroidEntity(StarwarsmodModElements instance) {
		super(instance, 365);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12037288, -11846891, new Item.Properties().group(SepratistAIItemGroup.tab))
				.setRegistryName("commando_droid_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelCommandoDroidCaptain(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/commandodroidcaptain.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(VirobladeItem.block));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, MouseDroidEntity.CustomEntity.class, true, false));
			...
			this.targetSelector.addGoal(19, new NearestAttackableTargetGoal(this, MouseDroidEntity.CustomEntity.class, true, false));
			...
			this.goalSelector.addGoal(31, new RandomWalkingGoal(this, 0.8));
			this.goalSelector.addGoal(32, new LeapAtTargetGoal(this, (float) 0.5));
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED) != null)
				this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.375);
	...
	public static class ModelCommandoDroidCaptain extends EntityModel {
		private final ModelRenderer CommandoDroidCaptain;
		...
		public ModelCommandoDroidCaptain() {
			textureWidth = 64;
			textureHeight = 64;
			CommandoDroidCaptain = new ModelRenderer(this);
			CommandoDroidCaptain.setRotationPoint(0.0F, 24.0F, 0.0F);
			setRotationAngle(CommandoDroidCaptain, 0.0436F, 0.0F, 0.0F);
			LeftLeg = new ModelRenderer(this);
			LeftLeg.setRotationPoint(3.0F, -18.0F, 3.0F);
			CommandoDroidCaptain.addChild(LeftLeg);
			...
			CommandoDroidCaptain.addChild(RightLeg);
			...
			CommandoDroidCaptain.addChild(Chest);
			...
			CommandoDroidCaptain.addChild(LeftArm);
			...
			CommandoDroidCaptain.addChild(RightArm);
			...
			addBoxHelper(cube_r16, 22, 39, 1.75F, 1.25F, -3.25F, 1, 3, 1, 0.0F, false);
			addBoxHelper(cube_r16, 24, 30, 1.75F, 1.25F, -14.25F, 1, 1, 1, 0.0F, false);
			addBoxHelper(cube_r16, 0, 0, 1.75F, 1.25F, -13.25F, 1, 2, 10, 0.0F, false);
			addBoxHelper(cube_r16, 4, 25, 1.75F, 1.25F, -2.25F, 1, 2, 3, 0.0F, false);
			...
			CommandoDroidCaptain.addChild(Head);
		...
		public void render(MatrixStack ms, IVertexBuilder vb, int i1, int i2, float f1, float f2, float f3, float f4) {
			CommandoDroidCaptain.render(ms, vb, i1, i2, f1, f2, f3, f4);
		}

...
import net.mcreator.starwarsmod.procedures.CloneCommandoBossThisEntityKillsAnotherOneProcedure;
import net.mcreator.starwarsmod.procedures.CloneCommandoBossOnInitialEntitySpawnProcedure;
import net.mcreator.starwarsmod.itemgroup.RepublicAIItemGroup;
import net.mcreator.starwarsmod.item.DC17MItem;
import net.mcreator.starwarsmod.item.BossBackpackItem;
...
public class CloneCommandoBossEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_commando_boss").setRegistryName("clone_commando_boss");
	public CloneCommandoBossEntity(StarwarsmodModElements instance) {
		super(instance, 252);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3381760, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_commando_boss_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/clone_commando_boss.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DC17MItem.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(BossBackpackItem.body));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:bosshurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:bossdeath"));
		}
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			Entity entity = this;
			{
				...
				CloneCommandoBossOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CloneCommandoBossThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}

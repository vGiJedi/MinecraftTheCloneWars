...
import net.mcreator.starwarsmod.item.RPS6Item;
import net.mcreator.starwarsmod.item.CloneTrooperPhase2FinWhiteItem;
...
public class ClonetrooperwithrocketEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clonetrooperwithrocket").setRegistryName("clonetrooperwithrocket");
	public ClonetrooperwithrocketEntity(StarwarsmodModElements instance) {
		super(instance, 396);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clonetrooperwithrocket_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/standard_clone_trooper.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(RPS6Item.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(CloneTrooperPhase2FinWhiteItem.helmet));
		}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(17, new LookAtGoal(this, PlayerEntity.class, (float) 5));

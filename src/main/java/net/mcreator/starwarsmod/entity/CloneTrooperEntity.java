...
public class CloneTrooperEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_trooper").setRegistryName("clone_trooper");
	public CloneTrooperEntity(StarwarsmodModElements instance) {
		super(instance, 219);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_trooper_spawn_egg"));
	}

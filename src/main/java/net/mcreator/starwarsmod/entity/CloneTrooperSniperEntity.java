...
import net.mcreator.starwarsmod.item.WhitefinandmacrovisoItem;
import net.mcreator.starwarsmod.item.Valken38xItem;
...
public class CloneTrooperSniperEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_trooper_sniper").setRegistryName("clone_trooper_sniper");
	public CloneTrooperSniperEntity(StarwarsmodModElements instance) {
		super(instance, 227);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("clone_trooper_sniper_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Valken38xItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(WhitefinandmacrovisoItem.helmet));
		}
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			Valken38xItem.shoot(this, target);
		}
	}
}

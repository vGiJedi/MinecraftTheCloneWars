...
import net.mcreator.starwarsmod.procedures.CloneCommandoSevThisEntityKillsAnotherOneProcedure;
import net.mcreator.starwarsmod.item.SevBackpackItem;
import net.mcreator.starwarsmod.item.DC17MSNIPERItem;
...
public class CloneCommandoSevEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("clone_commando_sev").setRegistryName("clone_commando_sev");
	public CloneCommandoSevEntity(StarwarsmodModElements instance) {
		super(instance, 249);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -6750208, new Item.Properties().group(null)).setRegistryName("clone_commando_sev_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/clone_commando_sev.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DC17MSNIPERItem.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(SevBackpackItem.body));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:sevhurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:sevdeath"));
		}
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				CloneCommandoSevThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			DC17MSNIPERItem.shoot(this, target);
		}
	}
}

...
import net.mcreator.starwarsmod.item.SenateCommandoCaptainPauldronItem;
import net.mcreator.starwarsmod.item.SenateCommandoCaptainFinItem;
import net.mcreator.starwarsmod.item.DC15Item;
import net.mcreator.starwarsmod.StarwarsmodModElements;

@StarwarsmodModElements.ModElement.Tag
public class SenateCommandoCaptainEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("senate_commando_captain").setRegistryName("senate_commando_captain");
	public SenateCommandoCaptainEntity(StarwarsmodModElements instance) {
		super(instance, 431);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14272666, -1, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("senate_commando_captain_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/senatecommandocaptain.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(SenateCommandoCaptainFinItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(SenateCommandoCaptainPauldronItem.body));
		}

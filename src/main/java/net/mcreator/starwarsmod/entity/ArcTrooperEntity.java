...
import net.mcreator.starwarsmod.procedures.ArcTrooperKillsAnotherOneProcedure;
import net.mcreator.starwarsmod.itemgroup.RepublicAIItemGroup;
import net.mcreator.starwarsmod.item.DualWieldDC17sItem;
import net.mcreator.starwarsmod.item.DC17OffhandItem;
import net.mcreator.starwarsmod.item.DC17MainhandItem;
import net.mcreator.starwarsmod.item.ArcTrooperRangefinderandFinItem;
import net.mcreator.starwarsmod.item.ArcBackpackItem;
...
public class ArcTrooperEntity extends StarwarsmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("arc_trooper").setRegistryName("arc_trooper");
	public ArcTrooperEntity(StarwarsmodModElements instance) {
		super(instance, 265);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -7849429, new Item.Properties().group(RepublicAIItemGroup.tab))
				.setRegistryName("arc_trooper_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("starwarsmod:textures/arctrooper_for_3d_armour.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(DC17OffhandItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(ArcTrooperRangefinderandFinItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(ArcBackpackItem.body));
		}
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, BattleDroidEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SuperBattleDroidEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, BuzzDroidMobEntity.CustomEntity.class, true, false));
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, SpiderDroidEntity.CustomEntity.class, true, false));
			...
			this.goalSelector.addGoal(18, new LookAtGoal(this, AnakinSkywalkerEntity.CustomEntity.class, (float) 5));
			this.goalSelector.addGoal(19, new LookAtGoal(this, ObiWanKenobiEntity.CustomEntity.class, (float) 5));
		...
		public void onKillEntity(LivingEntity entity) {
			...
			Entity sourceentity = this;
			{
				...
				ArcTrooperKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			DualWieldDC17sItem.shoot(this, target);
		}
	}
}

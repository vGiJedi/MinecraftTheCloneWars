...
public class ConsoleVariant1Block extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:console_variant_1")
	public static final Block block = null;
	public ConsoleVariant1Block(StarwarsmodModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("console_variant_1");
		}

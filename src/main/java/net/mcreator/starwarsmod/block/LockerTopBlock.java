...
public class LockerTopBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:locker_top")
	public static final Block block = null;
	public LockerTopBlock(StarwarsmodModElements instance) {
		super(instance, 104);
	}

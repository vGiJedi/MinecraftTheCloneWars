...
public class YellowLightBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:yellow_light")
	public static final Block block = null;
	public YellowLightBlock(StarwarsmodModElements instance) {
		super(instance, 162);
	}

...
public class LAATRailingBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:laat_railing")
	public static final Block block = null;
	public LAATRailingBlock(StarwarsmodModElements instance) {
		super(instance, 404);
	}

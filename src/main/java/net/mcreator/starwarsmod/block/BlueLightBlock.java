...
public class BlueLightBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:blue_light")
	public static final Block block = null;
	public BlueLightBlock(StarwarsmodModElements instance) {
		super(instance, 93);
	}

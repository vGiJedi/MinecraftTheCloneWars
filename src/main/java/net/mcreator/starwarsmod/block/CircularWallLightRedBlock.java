...
public class CircularWallLightRedBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:circular_wall_light_red")
	public static final Block block = null;
	public CircularWallLightRedBlock(StarwarsmodModElements instance) {
		super(instance, 259);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("circular_wall_light_red");
		}

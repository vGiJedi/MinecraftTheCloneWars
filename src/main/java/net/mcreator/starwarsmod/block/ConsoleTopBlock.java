...
public class ConsoleTopBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:console_top")
	public static final Block block = null;
	public ConsoleTopBlock(StarwarsmodModElements instance) {
		super(instance, 49);
	}

...
public class FlightSeatBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:flight_seat")
	public static final Block block = null;
	public FlightSeatBlock(StarwarsmodModElements instance) {
		super(instance, 408);
	}

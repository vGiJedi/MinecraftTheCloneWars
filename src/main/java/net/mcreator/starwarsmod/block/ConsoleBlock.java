...
public class ConsoleBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:console")
	public static final Block block = null;
	public ConsoleBlock(StarwarsmodModElements instance) {
		super(instance, 50);
	}

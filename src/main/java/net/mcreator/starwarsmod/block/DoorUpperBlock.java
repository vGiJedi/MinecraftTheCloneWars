...
public class DoorUpperBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:door_upper")
	public static final Block block = null;
	public DoorUpperBlock(StarwarsmodModElements instance) {
		super(instance, 70);
	}

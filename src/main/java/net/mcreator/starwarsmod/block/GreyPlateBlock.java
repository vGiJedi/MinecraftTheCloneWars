...
public class GreyPlateBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:grey_plate")
	public static final Block block = null;
	public GreyPlateBlock(StarwarsmodModElements instance) {
		super(instance, 56);
	}

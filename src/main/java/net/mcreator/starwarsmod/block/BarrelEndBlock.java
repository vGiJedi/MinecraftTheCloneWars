...
public class BarrelEndBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:barrel_end")
	public static final Block block = null;
	public BarrelEndBlock(StarwarsmodModElements instance) {
		super(instance, 95);
	}

...
public class CircularWallColumnBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:circular_wall_column")
	public static final Block block = null;
	public CircularWallColumnBlock(StarwarsmodModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("circular_wall_column");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case UP :
					return VoxelShapes.or(makeCuboidShape(0, 8, 0, 16, 0, 16)).withOffset(offset.x, offset.y, offset.z);
				case DOWN :

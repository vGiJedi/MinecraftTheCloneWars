...
public class ConsoleMidBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:console_mid")
	public static final Block block = null;
	public ConsoleMidBlock(StarwarsmodModElements instance) {
		super(instance, 60);
	}

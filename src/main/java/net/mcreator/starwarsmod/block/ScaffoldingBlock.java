...
public class ScaffoldingBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:scaffolding")
	public static final Block block = null;
	public ScaffoldingBlock(StarwarsmodModElements instance) {
		super(instance, 203);
	}

...
public class ComConsoleBlock extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:com_console")
	public static final Block block = null;
	public ComConsoleBlock(StarwarsmodModElements instance) {
		super(instance, 53);
	}

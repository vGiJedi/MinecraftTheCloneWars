...
public class ScorchBackpackItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:scorch_backpack_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:scorch_backpack_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:scorch_backpack_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:scorch_backpack_boots")
	public static final Item boots = null;
	public ScorchBackpackItem(StarwarsmodModElements instance) {
		super(instance, 316);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(StarWarsArmourItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/scorchbackpack.png";
			}
		}.setRegistryName("scorch_backpack_chestplate"));
	}

...
import net.mcreator.starwarsmod.procedures.E5BlasterRangedItemUsedProcedure;
...
public class E5BlasterItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:e_5_blaster")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybullete_5_blaster").setRegistryName("entitybullete_5_blaster");
	public E5BlasterItem(StarwarsmodModElements instance) {
		super(instance, 309);
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						E5BlasterRangedItemUsedProcedure.executeProcedure($_dependencies);
					}

...
public class CloneRangefinderItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:clone_rangefinder_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:clone_rangefinder_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:clone_rangefinder_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:clone_rangefinder_boots")
	public static final Item boots = null;
	public CloneRangefinderItem(StarwarsmodModElements instance) {
		super(instance, 223);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(StarWarsArmourItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedHead = new ModelCloneMacroVisor().Head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/macrovisortexture.png";
			}
		}.setRegistryName("clone_rangefinder_helmet"));
	}
	...
	public static class ModelCloneMacroVisor extends EntityModel {
		...
		public ModelCloneMacroVisor() {
			...
			addBoxHelper(Head, 0, 4, -3.5F, -5.25F, -6.5F, 7, 1, 1, 0.0F, false);

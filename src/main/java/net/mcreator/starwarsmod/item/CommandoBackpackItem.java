...
public class CommandoBackpackItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:commando_backpack_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:commando_backpack_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:commando_backpack_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:commando_backpack_boots")
	public static final Item boots = null;
	public CommandoBackpackItem(StarwarsmodModElements instance) {
		super(instance, 314);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(StarWarsArmourItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/commandobackpackstandard.png";
			}
		}.setRegistryName("commando_backpack_chestplate"));
	}

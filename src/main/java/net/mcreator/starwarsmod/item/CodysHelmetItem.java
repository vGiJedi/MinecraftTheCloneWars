...
public class CodysHelmetItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:codys_helmet_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:codys_helmet_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:codys_helmet_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:codys_helmet_boots")
	public static final Item boots = null;
	public CodysHelmetItem(StarwarsmodModElements instance) {
		super(instance, 350);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(StarWarsArmourItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedHead = new ModelCody_Helmet().Head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/cody_helmet.png";
			}
		}.setRegistryName("codys_helmet_helmet"));
	}

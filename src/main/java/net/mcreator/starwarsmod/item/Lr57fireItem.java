...
public class Lr57fireItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:lr_57fire")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletlr_57fire").setRegistryName("entitybulletlr_57fire");
	public Lr57fireItem(StarwarsmodModElements instance) {
		super(instance, 424);
	}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("starwarsmod:textures/lr57laser.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new Modellr57laser();
	...
	public static class Modellr57laser extends EntityModel {
		...
		public Modellr57laser() {
			...
			addBoxHelper(cube_r2_r2_r1, 0, 0, -4.0F, -13.0F, -16.5F, 1, 1, 8, 0.0F, false);
			addBoxHelper(cube_r2_r2_r1, 0, 0, 1.0F, -13.0F, -16.5F, 1, 1, 8, 0.0F, false);
			...
			addBoxHelper(cube_r1_r1_r1, 0, 0, -4.0F, -13.0F, -16.5F, 1, 1, 8, 0.0F, false);
			addBoxHelper(cube_r1_r1_r1, 0, 0, 1.0F, -13.0F, -16.5F, 1, 1, 8, 0.0F, false);
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:lr57fire")),

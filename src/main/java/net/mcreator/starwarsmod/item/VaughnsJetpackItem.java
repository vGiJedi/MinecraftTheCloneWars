...
public class VaughnsJetpackItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:vaughns_jetpack_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:vaughns_jetpack_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:vaughns_jetpack_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:vaughns_jetpack_boots")
	public static final Item boots = null;
	public VaughnsJetpackItem(StarwarsmodModElements instance) {
		super(instance, 353);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/vaughnjetpackandantenna.png";
			}
		...
		}.setRegistryName("vaughns_jetpack_chestplate"));
	}

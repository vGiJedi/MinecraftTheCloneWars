...
public class DC17OffhandItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:dc_17_offhand")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletdc_17_offhand").setRegistryName("entitybulletdc_17_offhand");
	public DC17OffhandItem(StarwarsmodModElements instance) {
		super(instance, 169);
	}

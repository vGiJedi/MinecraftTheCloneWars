...
public class CodysJetpackItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:codys_jetpack_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:codys_jetpack_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:codys_jetpack_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:codys_jetpack_boots")
	public static final Item boots = null;
	public CodysJetpackItem(StarwarsmodModElements instance) {
		super(instance, 352);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/codyjetpackandantenna.png";
			}
		...
		}.setRegistryName("codys_jetpack_chestplate"));
	}

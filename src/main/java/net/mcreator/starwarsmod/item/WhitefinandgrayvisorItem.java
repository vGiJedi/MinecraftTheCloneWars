...
public class WhitefinandgrayvisorItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:whitefinandgrayvisor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:whitefinandgrayvisor_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:whitefinandgrayvisor_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:whitefinandgrayvisor_boots")
	public static final Item boots = null;
	public WhitefinandgrayvisorItem(StarwarsmodModElements instance) {
		super(instance, 324);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(null)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedHead = new ModelWhite_fin_and_Gray_Visor().Head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/white_fin_and_gray_visor.png";
			}
		}.setRegistryName("whitefinandgrayvisor_helmet"));
	}
	...
	public static class ModelWhite_fin_and_Gray_Visor extends EntityModel {
		...
		public ModelWhite_fin_and_Gray_Visor() {
			...
			addBoxHelper(Head, 28, 120, -1.0F, -8.5F, -3.5F, 2, 1, 7, 0.0F, false);
		}

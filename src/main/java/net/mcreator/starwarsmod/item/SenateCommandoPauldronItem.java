...
public class SenateCommandoPauldronItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:senate_commando_pauldron_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:senate_commando_pauldron_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:senate_commando_pauldron_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:senate_commando_pauldron_boots")
	public static final Item boots = null;
	public SenateCommandoPauldronItem(StarwarsmodModElements instance) {
		super(instance, 426);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "senate_commando_pauldron";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/senatecommadnopauldron.png";
			}
		}.setRegistryName("senate_commando_pauldron_chestplate"));
	}

...
import net.mcreator.starwarsmod.procedures.RG4DRangedItemUsedProcedure;
...
public class RG4DItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:rg_4_d")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletrg_4_d").setRegistryName("entitybulletrg_4_d");
	public RG4DItem(StarwarsmodModElements instance) {
		super(instance, 377);
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						RG4DRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}

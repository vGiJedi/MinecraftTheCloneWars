...
import net.mcreator.starwarsmod.procedures.E5CRangedItemUsedProcedure;
...
public class E5CItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:e_5_c")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybullete_5_c").setRegistryName("entitybullete_5_c");
	public E5CItem(StarwarsmodModElements instance) {
		super(instance, 392);
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						E5CRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starwarsmod:e5cfire")),

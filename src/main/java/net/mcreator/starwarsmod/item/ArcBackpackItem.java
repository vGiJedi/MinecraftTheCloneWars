...
public class ArcBackpackItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:arc_backpack_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:arc_backpack_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:arc_backpack_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:arc_backpack_boots")
	public static final Item boots = null;
	public ArcBackpackItem(StarwarsmodModElements instance) {
		super(instance, 312);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(StarWarsArmourItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedBody = new Modelarcbackpackandpauldron().Body;
				armorModel.bipedLeftArm = new Modelarcbackpackandpauldron().LeftArm;
				armorModel.bipedRightArm = new Modelarcbackpackandpauldron().RightArm;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/arcbackpackandpauldron.png";
			}
		}.setRegistryName("arc_backpack_chestplate"));
	}
	// Made with Blockbench 3.7.4
	// Exported for Minecraft version 1.14
	// Paste this class into your mod and generate all required imports
	public static class Modelarcbackpackandpauldron extends EntityModel {
		private final ModelRenderer Body;
		private final ModelRenderer LeftArm;
		private final ModelRenderer RightArm;
		public Modelarcbackpackandpauldron() {
			textureWidth = 128;
			textureHeight = 128;

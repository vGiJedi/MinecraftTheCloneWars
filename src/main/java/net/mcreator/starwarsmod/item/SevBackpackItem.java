...
public class SevBackpackItem extends StarwarsmodModElements.ModElement {
	@ObjectHolder("starwarsmod:sev_backpack_helmet")
	public static final Item helmet = null;
	@ObjectHolder("starwarsmod:sev_backpack_chestplate")
	public static final Item body = null;
	@ObjectHolder("starwarsmod:sev_backpack_leggings")
	public static final Item legs = null;
	@ObjectHolder("starwarsmod:sev_backpack_boots")
	public static final Item boots = null;
	public SevBackpackItem(StarwarsmodModElements instance) {
		super(instance, 315);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(StarWarsArmourItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "starwarsmod:textures/sevbackpack.png";
			}
		}.setRegistryName("sev_backpack_chestplate"));
	}
